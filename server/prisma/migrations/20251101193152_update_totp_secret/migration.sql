...
-- CreateIndex
CREATE UNIQUE INDEX "totp_secrets_credential_id_key" ON "totp_secrets"("credential_id");

-- CreateIndex
CREATE UNIQUE INDEX "totp_secrets_service_name_key" ON "totp_secrets"("service_name");

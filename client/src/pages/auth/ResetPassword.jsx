...
import { Lock, Eye, EyeOff, Check, X, KeyRound, AlertTriangle } from 'lucide-react';
...
const ResetPassword = () => {
  ...
  try {
    // TODO: Verify recovery key with backend
          ...
          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div className="text-xs text-yellow-800">
                ...
                <p>Your recovery key can only be used once. After resetting your password, you'll need to generate a new recovery key.</p>
              </div>
            </div>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        ...
        <div className="space-y-5">
          <div>
            ...
            {formData.newPassword && (
              <div className="mt-3 p-3 bg-gray-50 rounded-lg space-y-2">
                ...
                <RequirementItem met={passwordRequirements.minLength} text="At least 16 characters" />
          ...
          >
            {loading ? 'Resetting...' : (isStep2Valid ? 'Reset Password' : 'Complete All Requirements')}
          </button>
        </div>
